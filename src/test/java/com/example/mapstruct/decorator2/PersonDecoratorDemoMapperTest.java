...
class PersonDecoratorDemoMapperTest {
   ...
   @Test void toPerson() {
      ...
      assertThat(person.getAccounts()
                       .stream()
                       .map(Account::getPerson)).allMatch(accountPerson -> accountPerson == person);

   }

   @Test void toPersonDto() {
      ...
      assertThat(personDto.getAccounts()
                          .stream()
                          .map(AccountDto::getPerson)).allMatch(p -> p == personDto);
